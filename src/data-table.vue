            ...
            <div>
                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                    ...
                    <span>
                        ...
                        <template v-else>
                            <input type="number" v-model="currentPage" @keyup="reload()" class="w-20 relative inline-flex items-center border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-50 focus:z-20 appearance-none bg-none cursor-pointer text-center" />
                        </template>
                    </span>
